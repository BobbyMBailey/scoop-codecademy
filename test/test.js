...
describe('Unit Test for BaseController - server/BaseController.js: ', function () {
  ...
  it('isUserAuthenticated() returns false', function () {
    ...
    // Just test for Request Body
    expect(BaseControllerModule.isUserAuthenticated(null, knownUsers)).to.be.false
    expect(BaseControllerModule.isUserAuthenticated({}, knownUsers)).to.be.false
    expect(BaseControllerModule.isUserAuthenticated({body: {}}, knownUsers)).to.be.false
    expect(BaseControllerModule.isUserAuthenticated({
      body:
      {
        username: null
      }
    }, knownUsers)).to.be.false
  ...
  it('isUserAuthenticated() returns true', function () {
    ...
    }, knownUsers)).to.be.true
  })
})

describe('Scoop - server.js: ', function () {
  let database, routes, originalDatabase, originalNextCommentId
